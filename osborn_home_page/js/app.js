$(function(){
    $("#hamburger").on("click",function(){
        // $("body").css("transform","translate3d(300px, 0px, 0px)",1000);
      
    $("body").css({"transform":"translate3d(300px, 0px, 0px)","transition-duration":"1s"});
    });
    $("#back-btn").on("click",function(){
      $("body").css("transform","translate3d(0px, 0px, 0px)");
    })
    $("#back-btn").on("click",function(){    //what does this means
